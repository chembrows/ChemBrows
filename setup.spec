...
rm_bins = ['libQtWebKit', 'libQtGui', 'libQtXmlPatterns', 'libmysqlclient',
           ...
           'libX11', 'libgstreamer', 'libgcrypt', 'libQtOpenGL.so', 'libfbclient',
           'libfreetype', 'libsqlite3', 'libQtDBus', 'libsystemd', 'libgstvideo',
           'liborc', 'libharfbuzz', 'libpcre', 'libmng', 'bncursesw', 'libgstbase',
           'libgstaudio', 'liblcms2', 'libQtSvg', 'libatlas', 'libgobject',
           ...
           'libqwbmp', 'libqwebp', 'libqtiff', 'libQt5PrintSupport', 'libunistring',
           'libgnutls', 'libglib-2.0', 'libkrb5', 'libgmp', 'libcups', 'libstdc++',
           '_cffi_backend', 'libQt5Svg', '_decimal', 'libxcb-glx', 'mkl_avx512_mic',
           'mkl_avx512', 'mkl_avx2', 'mkl_avx', 'mkl_mc3', 'mkl_mc', 'mkl_tbb_thread',
           'mkl_sequential', 'mkl_vml_avx512_mic', 'mkl_vml_avx', 'mkl_vml_avx512',
           'svml_dispmd']
